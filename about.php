...
<head>
	...
	<meta name="description" content="About Us | NirVriksh">
			...
			<div class="row">
				<div class="col-8 mx-auto text-center">
					...
					<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
						<li class="list-inline-item"><a href="https://nirvriksh.com">Home</a>
						</li>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7">
                    <div class="section-title">
                        ...
                        <h2 class="h1 mb-4">Empowering Your Business with Cutting-edge Solutions</h2>
                        <div class="content pe-0 pe-lg-5">
                            <p>Welcome to NirVriksh, where we specialize in providing a comprehensive range of services to elevate your business to new heights. Our offerings include:</p>
                            
                            <p>At NirVriksh, we are dedicated to delivering innovative solutions tailored to meet your unique needs. Our team of experts ensures that your business stays ahead in the rapidly evolving digital landscape.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <img loading="lazy" decoding="async" src="images/about1.jpg"
                        alt="Our Services" class="rounded w-100">
                </div>
            </div>
        </div>
    </section>
		...
		<div class="container">
            <div class="row justify-content-around">
                <div class="col-lg-5">
                    ...
                    <p class="lead">NirVriksh is a leading provider of digital solutions, specializing in web design and development, app development, Social Media Marketing, Graphics Design, AI, ML, and DevOps. As an independent service, our commitment is to provide unparalleled expertise and information to help businesses thrive in the digital era.</p>
                    <div class="content">At NirVriksh, we strive for excellence in every project. Our team is dedicated to crafting unique solutions that cater to the diverse needs of our clients.</div>
                </div>
                <div class="col-lg-5">
                    <div class="section-title">
                        <h2>What We Offer?</h2>
                    </div>
                    <p class="lead">Discover the seamless and efficient services offered by NirVriksh. Our streamlined processes ensure quick loan sanctions with easy documentation and doorstep service.</p>
                    <div class="content">
                        <ul>
		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
					...
					<p class="px-lg-5">We understand your requirements well enough to deliver what you need.</p>
				</div>
				<div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
					<div class="icon icon-lg bg-transparent mb-4"><i class="fas fa-briefcase text-primary"></i>
					</div>
					<h3>Instant Release</h3>
					<p class="px-lg-5">Once developed, we make the app live for real time tracking.</p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row align-items-center">
					...
					<div class="row position-relative gy-4">
						<div class="icon-box-item col-md-6">
							<div class="block bg-white">
								...
								<p class="mb-0">We are digital agency dedicated to providing genuine and innovative solutions, combining creativity and technical expertise to deliver authentic and impactful experiences for clients.</p>
							</div>
						</div>
						<div class="icon-box-item col-md-6">
							<div class="block bg-white">
								...
								<p class="mb-0">We provide compassionate service that understands and connects with individuals on a profound level. </p>
							</div>
						</div>
						<div class="icon-box-item col-md-6">
							<div class="block bg-white">
								...
								<p class="mb-0">We deal in forward-thinking and committed to enhancing overall organizational efficiency and effectiveness.</p>
							</div>
						</div>
						<div class="icon-box-item col-md-6">
							<div class="block bg-white">
								...
								<p class="mb-0">We are dedicated to prioritizing the needs and experiences of our customers.</p>
							</div>
						</div>
						<div class="has-shapes">
				...
				<div class="col-lg-6 mt-5 mt-lg-0">
					<div class="section-title ps-0 ps-lg-5">
						...
						<div class="content">
							<p>At NirVriksh, our core values define the essence of our commitment to excellence and client satisfaction. Innovation is deeply ingrained in our culture, driving us to explore new frontiers and deliver solutions that go beyond industry standards. We embrace a customer-centric approach, prioritizing the unique needs of our clients and ensuring every interaction is personalized and meaningful. Our success is intrinsically linked to the success of our clients, and we are unwavering in our dedication to quality excellence.</p>
							<p>Integrity and transparency form the bedrock of our relationships, fostering trust and open communication. We believe in continuous learning, staying abreast of technological advancements to provide solutions that are not only current but also forward-thinking. Collaboration and teamwork are integral to our culture, recognizing that collective effort fuels success. At NirVriksh, these core values underscore our commitment to providing unparalleled services and empowering businesses in today's dynamic landscape.</p>
						</div>
					</div>
				</div>
			</div>
