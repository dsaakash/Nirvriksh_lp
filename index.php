...
<head>
  ...
  <!-- theme meta -->
  <meta name="theme-name" content="NirVriksh" />
  <!-- # Google Fonts -->
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <h1 class="text-capitalize mb-4">Elevate your tech projects remotely</h1>
            <p class="mb-4">Explore cutting-edge services in web development, app creation, SEO optimization, machine
              learning, artificial intelligence, and DevOps. We've curated the finest offerings from top IT companies.
              All that's left is to choose what aligns best with your needs.</p> <a type="button"
              class="btn btn-primary" href="https://calendly.com/nirvriksh/meet-up">Book
              Appointment
              <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="ps-lg-5 text-center"> <img loading="lazy" decoding="async" src="images/home1.png"
              alt="banner image" class="w-100"> </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="section-title pt-4">
            ...
            <p>Our team of experts is dedicated to delivering technology services tailored to meet your unique needs and
              challenges.</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">01</span>
              ...
              <p class="mb-0 service-description">Crafting dynamic and responsive websites tailored to meet your unique
                business needs. Our web development services ensure a seamless online presence and user experience.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">02</span>
              <h3 class="mb-3 service-title">App Creation</h3>
              <p class="mb-0 service-description">Designing and developing innovative mobile applications that enhance
                user engagement and provide valuable solutions. From concept to launch, we bring your app ideas to life.
              </p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">03</span>
              <h3 class="mb-3 service-title">SEO Optimization</h3>
              <p class="mb-0 service-description">Optimizing your online presence to increase visibility and drive
                organic traffic. Our SEO services employ strategic techniques to enhance your website's search engine
                rankings and boost your digital footprint.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">04</span>
              <h3 class="mb-3 service-title">Machine Learning</h3>
              <p class="mb-0 service-description">Harnessing the power of machine learning algorithms to analyze data,
                extract insights, and make intelligent decisions. Our machine learning solutions empower businesses to
                leverage data for strategic advantages.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">05</span>
              <h3 class="mb-3 service-title">Artificial Intelligence</h3>
              <p class="mb-0 service-description">Integrating artificial intelligence into your systems to automate
                processes, enhance user experiences, and make informed business decisions. Our AI solutions drive
                efficiency and innovation across various industries.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="#">
            <div class="block"> <span class="colored-box text-center h3 mb-4">06</span>
              <h3 class="mb-3 service-title">DevOps</h3>
              <p class="mb-0 service-description">Implementing DevOps practices to streamline development and
                operations, ensuring faster delivery of high-quality software. Our DevOps services promote
                collaboration, automation, and continuous improvement in your IT processes.</p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="section-title">
            ...
            <h1>Empowering Businesses through Innovation and Technology</h1>
            <p class="lead mb-0 mt-4">
            <p>At NirVriksh, we specialize in transforming ideas into digital success stories. Our comprehensive
              services include cutting-edge solutions in web design and development, app development, SEO & SMM, DevOps,
              ML, and AI.</p>
            <p>With a focus on excellence, we leverage our expertise to create dynamic websites, innovative
              applications, and implement strategic SEO & SMM practices. Our commitment extends to optimizing operations
              through DevOps methodologies and harnessing the power of machine learning and artificial intelligence for
              intelligent business solutions.</p>
            </p>
            </p> <a class="btn btn-primary mt-4" href="about">Know About Us</a>
          </div>
        </div>
        <div class="col-lg-7 text-center text-lg-end"> <img loading="lazy" decoding="async" src="images/home2.png"
            alt="About Ourselves" class="img-fluid"> </div>
      </div>
    </div>
    <div class="has-shapes">
        ...
        <div class="col-lg-5">
          <div class="section-title">
            ...
            <div class="content mb-0 mt-4">
              <p>Discover the unique qualities that distinguish NirVriksh from the rest. We take pride in:</p>
              <ul>
                <li><strong>Exceptional Expertise:</strong> Our team excels in various fields, including web design and
                  development, app development, SEO & SMM, DevOps, ML, and AI, ensuring a comprehensive approach to your
                  digital needs.</li>
                <li><strong>Innovative Solutions:</strong> Embracing innovation, we provide creative and cutting-edge
                  solutions that propel your business forward in the dynamic digital landscape.</li>
                <li><strong>Client-Centric Philosophy:</strong> Your success is our priority. We are dedicated to
                  understanding and meeting your unique requirements, fostering a client-centric partnership.</li>
                <li><strong>Agility and Adaptability:</strong> In a rapidly evolving tech environment, we remain agile
                  and adaptive, ready to tackle challenges and seize opportunities with flexibility and efficiency.</li>
                <li><strong>Results-Driven Approach:</strong> Beyond delivering services, our focus is on achieving
                  tangible and impactful results for your business, ensuring measurable success.</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              <div class="icon me-4 mb-4 mb-sm-0"> <i class="fas fa-shield-alt mt-4" style="font-size:36px"></i> </div>
              <div class="block">
                <h3 class="mb-3">Fast And Secure Process</h3>
                <p class="mb-0">Our team will discuss all the details and requirememnts bnfore starting with the works
                  to make sure we make you happy by our development.</p>
              </div>
            </div>
          </div>
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              ...
              <div class="block">
                ...
                <p class="mb-0">Get clarification about the requirements and the tools to be used to make your business
                  grow and how to use them at the most.</p>
              </div>
            </div>
          </div>
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              ...
              <div class="block">
                <h3 class="mb-3">We Get You Your Project Quick</h3>
                <p class="mb-0">Based on the time limit, we believe to streamline our customers so that you can grow
                  your business as soon as possible and at a reasonable price.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="section-title text-center">
            ...
            <p class="lead mb-0">We believe in customer satisfaction</p>
          </div>
        </div>
      </div>
      <div class="row position-relative">
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/01.jpg" alt="Aarav Kapoor" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Aarav Kapoor</h4>
                <p class="mb-0">Happy Website Client</p>
              </div>
            </div>
            <div class="content">I am extremely pleased with the web design services provided by NirVriksh. The web
              designer, was dedicated and created a visually stunning website that perfectly aligns with my business
              needs. The attention to detail and user-friendly design exceeded my expectations. Highly recommended!
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/02.jpg" alt="Kavya Sharma" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Kavya Sharma</h4>
                <p class="mb-0">Satisfied App Client</p>
              </div>
            </div>
            <div class="content">Demonstrated exceptional skills in developing my mobile application. The app not only
              meets industry standards but also provides a seamless and enjoyable user experience. I appreciate the
              professionalism and expertise. Thank you!</div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/03.jpg" alt="Prisha Patel" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Prisha Patel</h4>
                <p class="mb-0">Delighted Machine Learning Client</p>
              </div>
            </div>
            <div class="content">I am delighted with the machine learning solutions provided by NirVriksh. The team
              demonstrated a deep understanding of my requirements and delivered a solution that exceeded my
              expectations. The impact on my business has been significant. Highly recommended!</div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/04.jpg" alt="Rohan Desai" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Rohan Desai</h4>
                <p class="mb-0">Thrilled DevOps Client</p>
              </div>
            </div>
            <div class="content">I am thrilled with the DevOps services provided by NirVriksh. The team streamlined our
              development processes, resulting in faster and more reliable software delivery. The impact on our
              efficiency has been tremendous. Exceptional service!</div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/05.jpg" alt="Sanya Mehta" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Sanya Mehta</h4>
                <p class="mb-0">Successful SEO Client</p>
              </div>
            </div>
            <div class="content">NirVriksh have truly delivered exceptional SEO services. Our online visibility has
              significantly improved, resulting in increased traffic and better rankings. Their expertise and strategic
              approach have made a positive impact on our digital presence. Highly satisfied!</div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            <div class="d-block d-sm-flex align-items-center mb-3"> <img loading="lazy" decoding="async"
                src="images/testimonials/06.jpg" alt="Vikram Gupta" class="img-fluid" width="65" height="66">
              <div class="mt-3 mt-sm-0 ms-0 ms-sm-3">
                <h4 class="h5 mb-1">Vikram Gupta</h4>
                <p class="mb-0">Happy Social Media Marketing Client</p>
              </div>
            </div>
            <div class="content">I am a happy customer of NirVriksh for their social media marketing services. The team
              have significantly boosted our online presence, engagement, and brand awareness. Their strategic approach
              and creativity have made a positive impact on our social media campaigns. Highly recommended! </div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="shadow rounded py-5 px-4 ms-0 ms-lg-4 bg-white position-relative">
            <div class="block mx-0 mx-lg-3 mt-0">
              ...
              <div class="content">Book an Appointment Now
                <br>Monday - Friday
                <br>8AM TO 11PM Indian Time
                <br> <a href="https://calendly.com/nirvriksh/meet-up">Book Now</a>
              </div>
            </div>
            <div class="block mx-0 mx-lg-3 mt-4">
              <h4 class="h5">Email your concern</h4>
              <div class="content">contact@nirvriksh.com </div>
            </div>
            <!-- <div class="block mx-0 mx-lg-3 mt-4">
