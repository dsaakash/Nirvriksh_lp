      ...
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <div class="content">
            ...
            <h3 id="use-of-the-information">Use of the Information</h3>
                <ul>
                    <li>Your privacy is crucial. We handle personal and client-related data with utmost confidentiality,
                        using it exclusively for the intended purposes.</li>
                    <li>We disclaim responsibility for issues related to non-receipt of services caused by inaccurate
                        order information or technical challenges beyond our control.</li>
                </ul>

                <h3 id="application-processing">Application Processing</h3>
                <ul>
                    <li>You are encouraged to share the outcomes of our services, but it is crucial to convey our licensing
                        terms to ensure awareness of copyrights.</li>
                </ul>

                <h3 id="what-services-we-render">Services We Render</h3>
                <p>Upon signing up for our services, we collect specific personal data, including your email address,
                    PayPal address (if different), and telephone number.</p>
                <ul>
                    <li>Our services, covering web design, app development, Social Media Marketing, Graphics Design, AI,
                        ML, and DevOps, are subject to licensing terms.</li>
                    <li>We are not liable for non-receipt of services if a valid email is not provided or if technical
                        issues are beyond our control.</li>
                    <li>You are welcome to share the outcomes of our services, but it is important to share our license
                        terms with others for copyright awareness.</li>
                </ul>

                <h3 id="intellectual-property-rights">Intellectual Property Rights</h3>
                <ul>
                    <li>Our themes and solutions are protected by intellectual property rights. Removing copyright links
                        without proper licensing is prohibited.</li>
                    <li>You have the right to use our themes and solutions for personal and commercial projects.</li>
                    <li>Reselling, redistributing, or sub-licensing any of our themes and solutions is strictly
                        prohibited.</li>
                    <li>You can host our templates on your website with full author credit.</li>
                    <li>Sharing our themes with your clients or friends is encouraged, but it is essential to share our
                        licensing terms with them for copyright awareness.</li>
                </ul>
                
                <h3 id="contact-us">Contact Us</h3>
                <p>If you have any questions or concerns about our Terms & Conditions, please contact us at <a href="mailto:contact@nirvriksh.com">contact@nirvriksh.com</a>.
          </div>
        </div>
      </div>
    </div>
