    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <div class="content">
            <h3 id="application-processing">Privacy Policy</h3>
            <p>Welcome to NirVriksh! This Privacy Policy outlines how we collect, use, and protect the personal information you provide on our website. By using our website, you consent to the terms described in this policy.</p>
            
            <h3 id="information-collected">Information Collected</h3>
            <p>We collect information that you voluntarily provide, including but not limited to names, email addresses, and phone numbers when you interact with our website, subscribe to newsletters, or use our services.</p>
            
            <h3 id="use-of-information">Use of Information</h3>
            <p>We use the collected information to enhance your experience, provide personalized content, and improve our services. We do not sell or share your information with third parties without your explicit consent unless required by law.</p>
            
            <h3 id="data-security">Data Security</h3>
            <p>Your data security is our priority. We employ encryption, access controls, and regular security assessments to protect your information from unauthorized access or disclosure.</p>
            
            <h3 id="cookie-policy">Cookie Policy</h3>
            <p>We use cookies to enhance your browsing experience. You can adjust your browser settings to refuse cookies, but some features may be affected. By continuing to use our site, you consent to our use of cookies.</p>
            
            <h3 id="updates-to-policy">Updates to Policy</h3>
            <p>We may update this Privacy Policy to reflect changes in our practices. Please review this page periodically for updates. Your continued use of our website indicates your acceptance of any changes.</p>
            
            <h3 id="contact-us">Contact Us</h3>
            <p>If you have any questions or concerns about our Privacy Policy, please contact us at <a href="mailto:contact@nirvriksh.com">contact@nirvriksh.com</a>.
            </p>
          </div>
        </div>
      </div>
