...
<head>
	<meta charset="utf-8">
	<title>Thank You | NirVriksh</title>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
					    <img src="images/thankyou.png" style="width: 300px">
						<!--<h1>Thank You!</h1>-->
						<p>We have received your query, we will get back to you soon.</p>
						<a href="https://nirvriksh.com"><button class="btn btn-primary w-100">Go to Homepage</button></a>
					</div>
				</div>
			</div>
		</div>
