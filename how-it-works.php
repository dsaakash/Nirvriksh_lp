...
<head>
	...
	<meta name="description" content="How it Works | NirVriksh">
			...
			<div class="row">
				<div class="col-8 mx-auto text-center">
					...
					<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
						...
						<li class="list-inline-item">/ &nbsp; <a href="how-it-works">How it works</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="row justify-content-between align-items-center">
				<div class="col-lg-5">
					<div class="section-title">
						...
						<h1>See How We Work to Make Your Business Grow.</h1>
						<p>
						<p>Our dedicated team works hard on aquiring your requirements so that we can deliver the best possible software that you deserve for your business development and growth.</p>
						<p>Based on the situation, we priotize the work and we provide system suppport with calls and emails for tension free software monitoring.</p>
						</p>
					</div>
				</div>
				<div class="col-lg-6 mt-5 mt-lg-0">
					<div class="has-video-popup position-relative">
						<img loading="lazy" decoding="async" src="images/howitworks1.png" alt="video thumb"
			...
			<div class="modal-content border-0">
				...
				<div class="modal-body p-0">
					<div class="ratio ratio-16x9 rounded-bottom overflow-hidden">
						<iframe src="" id="showVideo" allowscriptaccess="always" allow="autoplay"
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-7">
					<div class="section-title text-center">
						...
						<h1>Get Your Software/Service In Just 3 Easy Steps</h1>
					</div>
				</div>
			</div>
					...
					<div class="row justify-content-center">
						<div class="step-item col-lg-4 col-md-6">
							<div class="text-center">
								...
								<p class="mb-0">First step is to book an appointment so that we can fast track your requirements.</p>
							</div>
						</div>
						<div class="step-item col-lg-4 col-md-6">
							<div class="text-center">
								<p class="count">02</p>
								<h3 class="mb-3">Business Requirements</h3>
								<p class="mb-0">We decide a timeline based on your requirements and quote you best possible amount so that you can build the trust with us.</p>
							</div>
						</div>
						<div class="step-item col-lg-4 col-md-6">
							<div class="text-center">
								<p class="count">03</p>
								<h3 class="mb-3">Get your Project</h3>
								<p class="mb-0">As we develop, we give demos and sessions to confirm the development is going good and release each version for customer satisfaction.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						...
						<h1>You Will Get In Days</h1>
						<p>Fast Delivery is Our Priority</p>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="icon-box-item col-lg-4 col-md-6">
					<div class="block">
						...
						<p class="mb-0">Get your projects delivered as soon as possible on your server.</p>
					</div>
				</div>
				<div class="icon-box-item col-lg-4 col-md-6">
					<div class="block">
						...
						<p class="mb-0">We use unique ideas in all our projects so that you can grow your business without any tension.</p>
					</div>
				</div>
				<div class="icon-box-item col-lg-4 col-md-6">
					<div class="block">
						...
						<p class="mb-0">All our projects are also a relation with our customers to make a long term relationship.</p>
					</div>
				</div>
			</div>
		</div>
